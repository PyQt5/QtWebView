    ...
    if (url.isValid()) {
        if (url.isLocalFile()) {
            ...
            if (!QFile::exists(url.toLocalFile())) {
                QMetaObject::invokeMethod(this, "loadingChanged", Qt::QueuedConnection, Q_ARG(QWebViewLoadRequestPrivate, QWebViewLoadRequestPrivate(url, QWebView::LoadStartedStatus, {})));
                QMetaObject::invokeMethod(this, "loadingChanged", Qt::QueuedConnection, Q_ARG(QWebViewLoadRequestPrivate, QWebViewLoadRequestPrivate(url, QWebView::LoadFailedStatus, QStringLiteral("File does not exist"))));
                return;
            }
        ...
        QMetaObject::invokeMethod(this, "loadingChanged", Qt::QueuedConnection, Q_ARG(QWebViewLoadRequestPrivate, QWebViewLoadRequestPrivate(url, QWebView::LoadFailedStatus, QStringLiteral("Invalid URL"))));
    }
}
